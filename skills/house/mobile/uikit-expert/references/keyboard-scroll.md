...
// rises automatically when the keyboard appears without any animation code.
```
...
// Safe area insets propagate to subviews, causing unexpected child layout changes
```
