...
`implement` builds work from a [ticket](https://www.aihero.dev/ai-coding-dictionary/ticket), a [spec](https://www.aihero.dev/ai-coding-dictionary/spec), or an agreed plan in the conversation. It uses TDD where possible, typechecks, runs [code-review](https://aihero.dev/skills-code-review), and commits to the current branch.
...
| One concrete behaviour you want test-first, with no spec | [tdd](https://aihero.dev/skills-tdd) directly, or [tdd-kmp](../../skills/house/mobile/tdd-kmp/SKILL.md) for a KMP/CMP app |
...
2. Use [tdd-kmp](../../skills/house/mobile/tdd-kmp/SKILL.md) for KMP/CMP apps when installed; otherwise [tdd](https://aihero.dev/skills-tdd) (with [kmp-test-seams](../../skills/house/mobile/kmp-test-seams/SKILL.md) for KMP/CMP).
...
The **seam** is the public boundary where you observe behaviour. `/tdd` agrees seams before writing tests; `/tdd-kmp` tests at the lowest layer that owns the behaviour. Name the boundary in the spec so either route stays focused.
...
- You can see `/tdd` in the trace for other code, or `/tdd-kmp` for KMP/CMP work when installed, not just tests appearing in the diff.
...
Its neighbours are [to-tickets](https://aihero.dev/skills-to-tickets), which produces the tickets it consumes; [tdd](https://aihero.dev/skills-tdd) or [tdd-kmp](../../skills/house/mobile/tdd-kmp/SKILL.md), which drive test-first work; and [code-review](https://aihero.dev/skills-code-review), which reviews the change before the commit. It trusts the plan it was handed.
