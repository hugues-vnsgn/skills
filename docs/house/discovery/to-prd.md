...
You invoke this by typing `/to-prd`, and the agent won't reach for it on its own.
...
- Every number in the document traces to something someone actually said, so targets you never gave appear as `⚠ TBD`, not as plausible figures.
