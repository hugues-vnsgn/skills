...
If the tickets came from [to-tickets](https://aihero.dev/skills-to-tickets), the tracker they live on was configured by [setup-osxsystem-skills](../../skills/engineering/setup-osxsystem-skills/SKILL.md). `code-review` reads the same configuration to find the originating spec at close-out.
