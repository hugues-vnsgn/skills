...
The path from "we think we want this" to tickets an engineer can pick up without asking you a single clarifying question. Read it in order — each section feeds the next.
